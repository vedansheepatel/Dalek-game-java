...
public class CatchGame {
    ...
    public CatchGame() {
        ...
        //if the starting positions of the daleks are the same, make them crashed from the start
    ...
    public void playGame() {
        ...
        while (!win && !dead) {
            //get click
            //if doctor starts off as the same position as any of the daleks the player loses and the game stops
            ...
            if (dalek1.getRow() == dalek2.getRow() && dalek1.getCol() == dalek2.getCol()) {
                ...
                dalek1.crash();
                dalek2.crash();
                board.displayMessage("You have killed 2 daleks!");
